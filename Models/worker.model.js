...
const create = async ({id, first_name, last_name, role_id, telephone_number, location, email, password, status, gender, emergency_contact_name, emergency_contact_relationship, emergency_contact_number, License_number, Years_experience, education, Certifications, date_birth }) => {
    try {
        const query = {
            text: `
            INSERT INTO "worker" ("id", "first_name", "last_name", "role_id", "telephone number", "location", "email", "password", "status", "gender", "emergency_contact_name", "emergency_contact_relationship", "emergency_contact_number", "License_number", "Years_experience", "education", "Certifications", "date_birth")
